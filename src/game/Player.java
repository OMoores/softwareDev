...
public class Player implements Runnable {
    ...
    /**
     * Creates the file handler for the player, should be called when has a
     * cardValue, a takeFromPile and a discardPile
     */
    public void createFileHandler() {
        this.fileHandler = new FileHandler(cardValue, takeFromPile.getNum(), discardPile.getNum());
    }
    ...
    public synchronized Boolean hasWon() {
        // Flag represents if has found a card that isnt the same as the first in the
        // players card list
